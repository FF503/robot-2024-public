...
import org.frogforce503.robot2024.subsystems.Photon.CameraPos;
...
public class Util {
    ...
    public static RobotStatus.Bot parseRobotNameToEnum(final String robotName) {
        return RobotStatus.Bot.valueOf(robotName);
    }
