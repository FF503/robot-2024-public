...
public class BlueSource4NoteCMP extends AutoMode {
    ...
    public BlueSource4NoteCMP(CENTERLINE_NOTES note1, CENTERLINE_NOTES note2, CENTERLINE_NOTES note3) {
        ...
        aimMap.put(CENTERLINE_NOTES.D, Pair.of(0.0, 0.0)); // prev arm = 2.0
        aimMap.put(CENTERLINE_NOTES.E, Pair.of(0.0, 0.0));
        aimMap.put(CENTERLINE_NOTES.F, Pair.of(0.0, 0.0)); // prev arm = 2.0
        ...
        var grabEFirst = SwervePathBuilder.generate(4.8, 4.75,
            ...
            // }}
            Waypoint.fromHolonomicPose(startingPose),
            new Waypoint(FieldConfig.getInstance().BLUE_STAGE_RIGHT.minus(new Translation2d(0, 1.1)), null, Rotation2d.fromDegrees(26)),
