...
public class BlueAmp4CenterLineOFSZ_SHIFT extends AutoMode {
    ...
    public BlueAmp4CenterLineOFSZ_SHIFT(CENTERLINE_NOTES note1, CENTERLINE_NOTES note2, CENTERLINE_NOTES note3) {
        ...
        aimMap.put(CENTERLINE_NOTES.F, Pair.of(0.0, 0.25)); // before arm angle = 0.9
        ...
        var grabGFirst = SwervePathBuilder.generate(maxVel, maxAcc,
            ...
            new Waypoint(FieldConfig.getInstance().BLUE_STAGE_LEFT.plus(new Translation2d(0, 1.0)), null, Rotation2d.fromDegrees(-20)),
            new Waypoint(FieldConfig.getInstance().NOTE_G, null, Rotation2d.fromDegrees(-20))
        );

        var grabFFirst = SwervePathBuilder.generate(maxVel, maxAcc,
            Waypoint.fromHolonomicPose(goOutForFirstButShoot.getFinalHolonomicPose()),
            new Waypoint(FieldConfig.getInstance().BLUE_STAGE_RIGHT.interpolate(FieldConfig.getInstance().BLUE_STAGE_LEFT, 0.5).interpolate(FieldConfig.getInstance().BLUE_CENTER_STAGE, 0.5).plus(new Translation2d(0,Units.feetToMeters(1.0
            ))), null, new Rotation2d()),
        ...
        var grabHFirst = SwervePathBuilder.generate(maxVel, maxAcc,
            Waypoint.fromHolonomicPose(goOutForFirstButShoot.getFinalHolonomicPose()),
            new Waypoint(FieldConfig.getInstance().BLUE_STAGE_LEFT.plus(new Translation2d(0, 1.5)), null, temp.plus(Rotation2d.fromDegrees(40       
            ))),
        ...
        var grabGSecond = SwervePathBuilder.generate(maxVel, maxAcc,
            ...
            new Waypoint(FieldConfig.getInstance().BLUE_STAGE_LEFT.plus(new Translation2d(0, 1.0)), null, Rotation2d.fromDegrees(-10)),
            new Waypoint(FieldConfig.getInstance().NOTE_G, null, Rotation2d.fromDegrees(-10))
        );
        ...
        var grabHSecond = SwervePathBuilder.generate(maxVel, maxAcc,
            Waypoint.fromHolonomicPose(secondShotPose),
            // new Waypoint(FieldConfig.getInstance().BLUE_STAGE_LEFT.plus(new Translation2d(0, 1.5)), null, Rotation2d.fromDegrees(10)),
            new Waypoint(FieldConfig.getInstance().NOTE_H, null, Rotation2d.fromDegrees(10))
        );
        ...
        var comeBackScoreG = SwervePathBuilder.generate(maxVel, maxAcc,
            ...
            new Waypoint(FieldConfig.getInstance().BLUE_STAGE_LEFT.plus(new Translation2d(0, 1.25)), null, secondShotPose.getRotation().plus(Rotation2d.fromDegrees(3))),
        ...
        var comeBackScoreH = SwervePathBuilder.generate(maxVel, maxAcc,
            ...
            new Waypoint(FieldConfig.getInstance().BLUE_STAGE_LEFT.plus(new Translation2d(0, 1.5)), null, temp.plus(Rotation2d.fromDegrees(5))),
            Waypoint.fromHolonomicPose(secondShotPose/*.transformBy(new Transform2d(new Translation2d(), Rotation2d.fromDegrees(5)))*/)
        );
        ...
        scoreFirstPathPart1 = SwervePathBuilder.generate(4.6, 4.75, 0.0, scorePaths.get(note1).sample(1.0).velocityMetersPerSecond,
        ...
        scoreFirstPathPart2 = SwervePathBuilder.generate(4.6, 4.75, scorePaths.get(note1).sample(1.0).velocityMetersPerSecond, 0.0,
                                Waypoint.fromPlannedPathState(scorePaths.get(note1).sample(1.0)),
                                Waypoint.fromHolonomicPose(scorePaths.get(note1).getFinalHolonomicPose())
                            );

        scoreSecondPathPart1 = SwervePathBuilder.generate(4.6, 4.75, 0.0, scorePaths.get(note2).sample(1.0).velocityMetersPerSecond,
        ...
        scoreSecondPathPart2 = SwervePathBuilder.generate(4.6, 4.75, scorePaths.get(note2).sample(1.0).velocityMetersPerSecond, 0.0,
                                Waypoint.fromPlannedPathState(scorePaths.get(note2).sample(1.0)),
    ...
    public Command routine() {
        return Commands.sequence(
            ...
            RobotContainer.shootSequence().beforeStarting(Commands.parallel(RobotContainer.shooter.rampUp(), RobotContainer.hintAng(0, 0.65))),
            ...
            Commands.either(
                Commands.sequence(
                    driveAndIntake(scoreFirstPathPart2).alongWith(RobotContainer.shooter.rampUp(), RobotContainer.hintAng(aimMap.get(this.note1))), // 3, 2)
                    ...
                    driveAndFetchFixed(grabSecondPaths.get(this.note2), 0.75)
                ),
                Commands.sequence(
            ...
            Commands.either(
                Commands.sequence(
                    driveAndIntake(scorePaths.get(this.note2)).alongWith(RobotContainer.shooter.rampUp(), RobotContainer.hintAng(aimMap.get(this.note2))),
                    ...
                    driveAndFetchFixed(grabSecondPaths.get(this.note3), 0.75)
                ),
                Commands.sequence(
            ...
            driveAndIntake(scorePaths.get(this.note3)).alongWith(RobotContainer.shooter.rampUp(), RobotContainer.hintAng(aimMap.get(this.note3))),
