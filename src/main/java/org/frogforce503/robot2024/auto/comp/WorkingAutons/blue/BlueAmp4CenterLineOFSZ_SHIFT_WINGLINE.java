...
public class BlueAmp4CenterLineOFSZ_SHIFT_WINGLINE extends AutoMode {
    ...
    public BlueAmp4CenterLineOFSZ_SHIFT_WINGLINE(CENTERLINE_NOTES note1, CENTERLINE_NOTES note2, CENTERLINE_NOTES note3) {
        ...
        Pose2d startingPose = setupPose(
            Waypoints.facingGoal(
                FieldConfig.getInstance().NOTE_K.interpolate(FieldConfig.getInstance().NOTE_J, 0.5).minus(new Translation2d(1.0, 0.0))
            )
        );

        Pose2d shotPose = Waypoints.facingGoal(
            FieldConfig.getInstance().BLUE_STAGE_LEFT.plus(new Translation2d(-0.5, 1.0))
        );

        var grabHFirst = SwervePathBuilder.generate(maxVel, maxAcc,
            Waypoint.fromHolonomicPose(startingPose),
            new Waypoint(FieldConfig.getInstance().NOTE_H, null, new Rotation2d())
        );

        var grabGFirst = SwervePathBuilder.generate(maxVel, maxAcc,
            Waypoint.fromHolonomicPose(startingPose),
            new Waypoint(FieldConfig.getInstance().BLUE_STAGE_LEFT.plus(new Translation2d(0.0, 1.0))),
            new Waypoint(FieldConfig.getInstance().NOTE_G, null, new Rotation2d())
        );

        var grabFFirst = SwervePathBuilder.generate(maxVel, maxAcc,
            Waypoint.fromHolonomicPose(startingPose),
            new Waypoint(FieldConfig.getInstance().BLUE_STAGE_LEFT.plus(new Translation2d(0.5, 1.0)), null, Rotation2d.fromDegrees(-30)),
            new Waypoint(FieldConfig.getInstance().NOTE_F, null, Rotation2d.fromDegrees(-30))
        );
        ...
        var grabGSecond = SwervePathBuilder.generate(maxVel, maxAcc,
            Waypoint.fromHolonomicPose(shotPose).withHolonomicRotation(new Rotation2d()),
            new Waypoint(FieldConfig.getInstance().BLUE_STAGE_LEFT.plus(new Translation2d(1.0, 1.0)), null, new Rotation2d()),
            new Waypoint(FieldConfig.getInstance().NOTE_G, null, new Rotation2d())
        );

        var grabFSecond = SwervePathBuilder.generate(maxVel, maxAcc,
            Waypoint.fromHolonomicPose(shotPose).withHolonomicRotation(Rotation2d.fromDegrees(-30)),
            new Waypoint(FieldConfig.getInstance().BLUE_STAGE_LEFT.plus(new Translation2d(1.0, 1.0)), null, Rotation2d.fromDegrees(-30)),
            new Waypoint(FieldConfig.getInstance().NOTE_F, null, Rotation2d.fromDegrees(-30))
        );
        ...
        var scoreG = SwervePathBuilder.generate(maxVel_SHOT, maxAcc_SHOT,
            ...
            new Waypoint(FieldConfig.getInstance().BLUE_STAGE_LEFT.plus(new Translation2d(1.0, 1.0)), null, shotPose.getRotation()),
            Waypoint.fromHolonomicPose(shotPose)
        );
        ...
        driveFtoG = SwervePathBuilder.generate(maxVel_SHIFT, maxAcc_SHIFT, 
            Waypoint.fromPlannedPathState(scoreF.sample(timeToWaitUntilBail)).withHolonomicRotation(new Rotation2d()),
            new Waypoint(grabGFirst.getFinalHolonomicPose().getTranslation(), null, new Rotation2d())
        );

        driveFtoH = SwervePathBuilder.generate(maxVel_SHIFT, maxAcc_SHIFT, 
            Waypoint.fromPlannedPathState(scoreF.sample(timeToWaitUntilBail)).withHolonomicRotation(Rotation2d.fromDegrees(30)),
            new Waypoint(FieldConfig.getInstance().NOTE_G.plus(new Translation2d(-1.25, 0.5)), null, Rotation2d.fromDegrees(30)),
            new Waypoint(grabHFirst.getFinalHolonomicPose().getTranslation(), null, Rotation2d.fromDegrees(30))
        );

        driveGtoF = SwervePathBuilder.generate(maxVel_SHIFT, maxAcc_SHIFT, 
            Waypoint.fromPlannedPathState(scoreG.sample(timeToWaitUntilBail)).withHolonomicRotation(new Rotation2d()),
            new Waypoint(FieldConfig.getInstance().NOTE_F.plus(new Translation2d(-1.25, 0.5)), null, new Rotation2d()),
        ...
        driveGtoH = SwervePathBuilder.generate(maxVel_SHIFT, maxAcc_SHIFT, 
            Waypoint.fromPlannedPathState(scoreG.sample(timeToWaitUntilBail)).withHolonomicRotation(Rotation2d.fromDegrees(10)),
            new Waypoint(grabHFirst.getFinalHolonomicPose().getTranslation(), null, Rotation2d.fromDegrees(10))
        );

        driveHtoF = SwervePathBuilder.generate(maxVel_SHIFT, maxAcc_SHIFT, 
            Waypoint.fromPlannedPathState(scoreH.sample(timeToWaitUntilBail)).withHolonomicRotation(new Rotation2d()),
            new Waypoint(FieldConfig.getInstance().NOTE_F.plus(new Translation2d(1.25, 0.5)), null, new Rotation2d()),
            new Waypoint(grabFFirst.getFinalHolonomicPose().getTranslation(), null, new Rotation2d())
        );

        driveHtoG = SwervePathBuilder.generate(maxVel_SHIFT, maxAcc_SHIFT, 
            Waypoint.fromPlannedPathState(scoreH.sample(timeToWaitUntilBail)).withHolonomicRotation(Rotation2d.fromDegrees(-20)),
            new Waypoint(grabGFirst.getFinalHolonomicPose().getTranslation(), null, Rotation2d.fromDegrees(-20))
        );
