...
public class BlueAmp4CenterLineOFSZ extends AutoMode {
    ...
    public BlueAmp4CenterLineOFSZ (CENTERLINE_NOTES note1, CENTERLINE_NOTES note2, CENTERLINE_NOTES note3) {
        ...
        aimMap.put(CENTERLINE_NOTES.F, Pair.of(0.0, 0.75)); // before arm angle = 0.9
        aimMap.put(CENTERLINE_NOTES.G, Pair.of(0.0, 0.75));
        aimMap.put(CENTERLINE_NOTES.H, Pair.of(0.0, 0.75));
        ...
        var comeBackScoreF = SwervePathBuilder.generate(maxVel, maxAcc,
            ...
            Waypoint.fromHolonomicPose(secondShotPose.transformBy(new Transform2d(new Translation2d(0.0, Units.feetToMeters(-3.0)), Rotation2d.fromDegrees(-5.0))))
        );
    ...
    public Command routine() {
        return Commands.sequence(
            ...
            Commands.deadline( // grabs G while shooting P
                ...
                Commands.waitUntil(() -> RobotContainer.drive.getPose().getTranslation().getX() >= firstShotPos.getX() - Units.feetToMeters(2.0)) // 2
                    .deadlineWith(RobotContainer.hintAng(0, 2))
                    .andThen(
