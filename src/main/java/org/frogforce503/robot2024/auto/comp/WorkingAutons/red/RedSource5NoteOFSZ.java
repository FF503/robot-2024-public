...
public class RedSource5NoteOFSZ extends AutoMode {
    ...
    public RedSource5NoteOFSZ(CENTERLINE_NOTES note1, CENTERLINE_NOTES note2, CENTERLINE_NOTES note3) {
        ...
        var grabFFirst = SwervePathBuilder.generate(4.8, 4.75,
            Waypoint.fromHolonomicPose(startingPose),
            new Waypoint(FieldConfig.getInstance().RED_CENTER_STAGE.plus(new Translation2d(0.0, -0.75)), null, shootingPose.getRotation()),
