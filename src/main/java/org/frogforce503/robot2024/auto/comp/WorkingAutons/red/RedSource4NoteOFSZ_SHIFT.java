...
public class RedSource4NoteOFSZ_SHIFT extends AutoMode {
    ...
    public RedSource4NoteOFSZ_SHIFT(CENTERLINE_NOTES note1, CENTERLINE_NOTES note2, CENTERLINE_NOTES note3) {
        ...
        var startingPose = setupPose(
            Waypoints.facingGoal(new Translation2d(FieldConfig.getInstance().RED_INITIATION_LINE + 0.5, FieldConfig.getInstance().NOTE_A.getY()))
        );
        ...
        var grabDFirst = SwervePathBuilder.generate(maxVel, maxAcc,
            ...
            new Waypoint(FieldConfig.getInstance().RED_STAGE_LEFT.plus(new Translation2d(0.0, -1.0)), null, new Rotation2d(Math.PI).plus(Rotation2d.fromDegrees(20))),
            new Waypoint(FieldConfig.getInstance().NOTE_D, null, new Rotation2d(Math.PI).plus(Rotation2d.fromDegrees(20)))
        );

        var grabEFirst = SwervePathBuilder.generate(maxVel, maxAcc,
            Waypoint.fromHolonomicPose(startingPose),
            new Waypoint(FieldConfig.getInstance().RED_STAGE_LEFT.plus(new Translation2d(0, -1.0)), null, new Rotation2d(Math.PI).plus(Rotation2d.fromDegrees(10))),
            new Waypoint(FieldConfig.getInstance().NOTE_E, null, new Rotation2d(Math.PI).plus(Rotation2d.fromDegrees(10)))
        );

        var grabFFirst = SwervePathBuilder.generate(maxVel, maxAcc,
            Waypoint.fromHolonomicPose(startingPose),
            new Waypoint(FieldConfig.getInstance().RED_CENTER_STAGE.plus(new Translation2d(0.0, -0.82)), null, new Rotation2d(Math.PI)),
        ...
        var grabDSecond = SwervePathBuilder.generate(maxVel, maxAcc,
            Waypoint.fromHolonomicPose(shotPose).withHolonomicRotation(new Rotation2d(Math.PI).plus(Rotation2d.fromDegrees(20))),
            new Waypoint(FieldConfig.getInstance().RED_STAGE_LEFT.interpolate(FieldConfig.getInstance().RED_STAGE_RIGHT, 0.5), null, new Rotation2d(Math.PI).plus(Rotation2d.fromDegrees(20))),
            new Waypoint(FieldConfig.getInstance().NOTE_D, null, new Rotation2d(Math.PI).plus(Rotation2d.fromDegrees(20)))
        );

        var grabESecond = SwervePathBuilder.generate(maxVel, maxAcc,
            Waypoint.fromHolonomicPose(shotPose).withHolonomicRotation(new Rotation2d(Math.PI).plus(Rotation2d.fromDegrees(15))),
        ...
        driveDtoE = SwervePathBuilder.generate(maxVel_SHIFT, maxAcc_SHIFT,
            Waypoint.fromPlannedPathState(scoreD.sample(timeToWaitUntilBail)).withHolonomicRotation(new Rotation2d(Math.PI)),
            new Waypoint(grabEFirst.getFinalHolonomicPose().getTranslation(), null, new Rotation2d(Math.PI))
        );

        driveDtoF = SwervePathBuilder.generate(maxVel_SHIFT, maxAcc_SHIFT, 
            Waypoint.fromPlannedPathState(scoreD.sample(timeToWaitUntilBail)).withHolonomicRotation(new Rotation2d(Math.PI).plus(Rotation2d.fromDegrees(-25))),
            new Waypoint(grabFFirst.getFinalHolonomicPose().getTranslation(), null, new Rotation2d(Math.PI).plus(Rotation2d.fromDegrees(-25)))
        );

        driveEtoD = SwervePathBuilder.generate(maxVel_SHIFT, maxAcc_SHIFT, 
            Waypoint.fromPlannedPathState(scoreE.sample(timeToWaitUntilBail)).withHolonomicRotation(new Rotation2d(Math.PI).plus(Rotation2d.fromDegrees(25))),
            new Waypoint(grabDFirst.getFinalHolonomicPose().getTranslation(), null, new Rotation2d(Math.PI).plus(Rotation2d.fromDegrees(25)))
        );

        driveEtoF = SwervePathBuilder.generate(maxVel_SHIFT, maxAcc_SHIFT, 
            Waypoint.fromPlannedPathState(scoreE.sample(timeToWaitUntilBail)).withHolonomicRotation(new Rotation2d(Math.PI)),
        ...
        driveFtoD = SwervePathBuilder.generate(maxVel_SHIFT, maxAcc_SHIFT, 
            Waypoint.fromPlannedPathState(scoreF.sample(timeToWaitUntilBail)).withHolonomicRotation(new Rotation2d(Math.PI).plus(Rotation2d.fromDegrees(25))),
            new Waypoint(grabDFirst.getFinalHolonomicPose().getTranslation(), null, new Rotation2d(Math.PI).plus(Rotation2d.fromDegrees(25)))
        );

        driveFtoE = SwervePathBuilder.generate(maxVel_SHIFT, maxAcc_SHIFT, 
            Waypoint.fromPlannedPathState(scoreF.sample(timeToWaitUntilBail)).withHolonomicRotation(new Rotation2d(Math.PI).plus(Rotation2d.fromDegrees(15))),
            new Waypoint(grabEFirst.getFinalHolonomicPose().getTranslation(), null, new Rotation2d(Math.PI).plus(Rotation2d.fromDegrees(15)))
        );
